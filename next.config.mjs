...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/bergen-county", destination: "/areas", permanent: true },
      { source: "/essex-county", destination: "/areas", permanent: true },
      { source: "/bergen-county-epoxy", destination: "/areas", permanent: true },
      { source: "/essex-county-epoxy", destination: "/areas", permanent: true },
      { source: "/passaic-county-epoxy", destination: "/areas", permanent: true },
      { source: "/hudson-county-epoxy", destination: "/areas", permanent: true },
      { source: "/morris-county-epoxy", destination: "/areas", permanent: true },
